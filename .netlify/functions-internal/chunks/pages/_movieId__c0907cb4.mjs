...
import { deepmerge, formatMuiErrorMessage, unstable_generateUtilityClass, unstable_capitalize, unstable_useEnhancedEffect, unstable_useEventCallback, unstable_useForkRef, unstable_useIsFocusVisible, unstable_generateUtilityClasses, chainPropTypes, integerPropType, unstable_composeClasses, refType, elementTypeAcceptingRef, unstable_ClassNameGenerator, internal_resolveProps } from '@mui/utils';
...
unstable_generateUtilityClasses('MuiAppBar', ['root', 'positionFixed', 'positionAbsolute', 'positionSticky', 'positionStatic', 'positionRelative', 'colorDefault', 'colorPrimary', 'colorSecondary', 'colorInherit', 'colorTransparent', 'colorError', 'colorInfo', 'colorSuccess', 'colorWarning']);
...
const Container = createContainer({
  createStyledComponent: styled$1('div', {
    ...
    overridesResolver: (props, styles) => {
      ...
      return [styles.root, styles[`maxWidth${unstable_capitalize(String(ownerState.maxWidth))}`], ownerState.fixed && styles.fixed, ownerState.disableGutters && styles.disableGutters];
    }
  }),
...
function getLinkUtilityClass(slot) {
  return unstable_generateUtilityClass('MuiLink', slot);
}
const linkClasses = unstable_generateUtilityClasses('MuiLink', ['root', 'underlineNone', 'underlineHover', 'underlineAlways', 'button', 'focusVisible']);
...
const _excluded$5 = ["className", "color", "component", "onBlur", "onFocus", "TypographyClasses", "underline", "variant", "sx"];
const useUtilityClasses$5 = ownerState => {
  ...
  const slots = {
    root: ['root', `underline${unstable_capitalize(underline)}`, component === 'button' && 'button', focusVisible && 'focusVisible']
  };
  return unstable_composeClasses(slots, getLinkUtilityClass, classes);
};
const LinkRoot = styled$1(Typography$1, {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, styles[`underline${unstable_capitalize(ownerState.underline)}`], ownerState.component === 'button' && styles.button];
  }
})(({
  theme,
  ownerState
...
const Link = /*#__PURE__*/React.forwardRef(function Link(inProps, ref) {
  ...
  const [focusVisible, setFocusVisible] = React.useState(false);
  const handlerRef = unstable_useForkRef(ref, focusVisibleRef);
...
unstable_generateUtilityClasses('MuiList', ['root', 'padding', 'dense', 'subheader']);
...
const useUtilityClasses$4 = ownerState => {
  ...
  return unstable_composeClasses(slots, getListUtilityClass, classes);
};
...
const listItemButtonClasses = unstable_generateUtilityClasses('MuiListItemButton', ['root', 'focusVisible', 'dense', 'alignItemsFlexStart', 'disabled', 'divider', 'gutters', 'selected']);
...
const useUtilityClasses$3 = ownerState => {
  ...
  const composedClasses = unstable_composeClasses(slots, getListItemButtonUtilityClass, classes);
  return _extends({}, classes, composedClasses);
};
...
const ListItemButton = /*#__PURE__*/React.forwardRef(function ListItemButton(inProps, ref) {
  ...
  const handleRef = unstable_useForkRef(listItemRef, ref);
  return /*#__PURE__*/jsx(ListContext$1.Provider, {
    value: childContext,
...
const listItemTextClasses = unstable_generateUtilityClasses('MuiListItemText', ['root', 'multiline', 'dense', 'inset', 'primary', 'secondary']);
...
const useUtilityClasses$2 = ownerState => {
  ...
  return unstable_composeClasses(slots, getListItemTextUtilityClass, classes);
};
...
unstable_generateUtilityClasses('MuiSkeleton', ['root', 'text', 'rectangular', 'rounded', 'circular', 'pulse', 'wave', 'withChildren', 'fitContent', 'heightAuto']);
...
const useUtilityClasses$1 = ownerState => {
  ...
  return unstable_composeClasses(slots, getSkeletonUtilityClass, classes);
};
...
const Header = () => {
  return /* @__PURE__ */ jsx(Box$1, { sx: { flexGrow: 1 }, children: /* @__PURE__ */ jsx(AppBar$1, { position: "static", sx: { background: "linear-gradient(to right, #007BFF, #28A745)", py: 2 }, children: /* @__PURE__ */ jsx(Container$1, { maxWidth: "xl", children: /* @__PURE__ */ jsxs(Toolbar$1, { children: [
    /* @__PURE__ */ jsx(Typography$1, { variant: "h6", sx: { flexGrow: 1 }, children: "My App" }),
    /* @__PURE__ */ jsx(List$1, { sx: { display: "flex", flexDirection: "row", alignItems: "center" }, component: "nav", "aria-labelledby": "main navigation", children: /* @__PURE__ */ jsx(NavigationLinks, {}) })
  ] }) }) }) });
};

const Footer = () => {
  return /* @__PURE__ */ jsxs(Box$1, { component: "footer", sx: {
    backgroundColor: "#f5f5f5",
    minHeight: 300,
    padding: 4,
    marginTop: 4
  }, children: [
    /* @__PURE__ */ jsx(Typography$1, { variant: "body2", color: "textSecondary", align: "center", children: "Lorem ipsum dolor sit amet, consectetur adipiscing elit." }),
    /* @__PURE__ */ jsxs(Typography$1, { variant: "body2", color: "textSecondary", align: "center", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Your Company Name"
    ] }),
    /* @__PURE__ */ jsxs(Typography$1, { variant: "body2", color: "textSecondary", align: "center", sx: { marginTop: 2 }, children: [
      /* @__PURE__ */ jsx(Link$1, { href: "#", children: "Privacy Policy" }),
      " | ",
      /* @__PURE__ */ jsx(Link$1, { href: "#", children: "Terms of Service" })
    ] })
  ] });
};
...
}, "/Users/marcus.karrman/projects/astro-demo/astro-starwars/src/pages/ssr-movies/[movieId].astro", void 0);

const $$file = "/Users/marcus.karrman/projects/astro-demo/astro-starwars/src/pages/ssr-movies/[movieId].astro";
const $$url = "/ssr-movies/[movieId]";
...
export { $$Layout as $, Box$1 as B, Movie as M, Skeleton$1 as S, Typography$1 as T, _movieId_ as _, Button$1 as a };
